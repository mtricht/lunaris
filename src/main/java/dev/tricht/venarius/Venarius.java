...
import dev.tricht.venarius.com.pathofexile.PathOfExileAPI;
import dev.tricht.venarius.item.ItemGrabber;
import dev.tricht.venarius.listeners.*;
...
public class Venarius {
    ...
    private void createSysTray() {
        ...
        final PopupMenu popup = new PopupMenu("Venarius");
    ...
    private static Image getIcon() {
        URL imageURL = Venarius.class.getClassLoader().getResource("icon.png");

        if (imageURL == null) {
            log.error("icon.png missing");
            return null;
        } else {
            return (new ImageIcon(imageURL, "Venarius")).getImage();
        }
    }
